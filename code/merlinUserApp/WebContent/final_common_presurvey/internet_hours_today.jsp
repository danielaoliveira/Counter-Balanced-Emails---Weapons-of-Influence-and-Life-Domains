...
<body>
	<div id='content'>
		...
		<div class='question'>How many hours have you already spent on the internet today?</div>
			<input class='visible-elements' type="radio" name="hours" value="1">1
			<input class='visible-elements' type="radio" name="hours" value="2">2
			<input class='visible-elements' type="radio" name="hours" value="3">3
			<input class='visible-elements' type="radio" name="hours" value="4">4
			<input class='visible-elements' type="radio" name="hours" value="5">5
			<input class='visible-elements' type="radio" name="hours" value="6">6
			<input class='visible-elements' type="radio" name="hours" value="7">7
			<input class='visible-elements' type="radio" name="hours" value="8">8
			<input class='visible-elements' type="radio" name="hours" value="9">9
			<input class='visible-elements' type="radio" name="hours" value="10">10
			<input class='visible-elements' type="radio" name="hours" value="11">11
			<input class='visible-elements' type="radio" name="hours" value="12">12
