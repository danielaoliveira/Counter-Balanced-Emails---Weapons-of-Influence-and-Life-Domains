	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Claim Gift from Chef Skills</div>
				<br>
				
				<div name="greeting">Hello Kyle!</div>
				
				<div name="mail-body">
					<p>A friend has sent you a gift through Chef Skills. Please click the link below to claim your gift and e-card.</p>
					
					<a href="http://www.harperkellerservices.com/claimgift-financial/">http://www.harperkellerservices.com/claimgift-financial/</a>
					
					<p>Chef Skills prides itself in being a community-based company that provides only the best quality instructional cooking videos for aspiring chefs and household cooks around the world. Please enjoy your personalized gift and feel free to send an equally thoughtful gift in return.</p>
