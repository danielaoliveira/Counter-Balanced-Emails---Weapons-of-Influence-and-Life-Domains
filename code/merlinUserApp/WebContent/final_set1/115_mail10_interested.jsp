	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: New Aerobics Class</div>
				<br>
				
				<div name="greeting">Hi Jackie,</div>
				
				<div name="mail-body">
					<p>Join a new aerobics class opening up near you! Space is very limited. This class offers cardiovascular training as well as endurance improvement. Lose weight the healthiest way with our most qualified instructors. Click on the link below to confirm your spot in the class. This offer ends in 4 days.</p>
					
					<a href="http://www.spectrehealth.com/exerciseclass-health/">http://www.spectrehealth.com/exerciseclass-health/ </a><br><br>
					
					<div name="signature">
						Wilson Brown<br>
						Gator Well Athletic Center<br>
						3454 sw 24th street Gainesville FL.
					</div>
