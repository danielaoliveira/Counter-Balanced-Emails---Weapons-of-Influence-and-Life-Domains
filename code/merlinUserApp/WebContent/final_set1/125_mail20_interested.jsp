	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Local Justice Legal Action Notice</div>
				<br>
				
				<div name="greeting">Dear Tiana,</div>
				
				<div name="mail-body">
				
					<p>There has been a legal action filed against you within the past 7 days waiting on your response. You are scheduled for a court trial in 30 days. Information about the lawsuit is available at the portal on the link below. Enter code: 006*AK0.</p>
				
					<a href="http://www.harbenlock.com/legalaction-legal/">http://www.harbenlock.com/legalaction-legal/</a><br>
					
					<div name="signature">
					Olivia Jackson<br>
					Gainesville Local Department of Justice<br>
					3454 2nd Ave. Gainesville FL
					</div>
