	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Join a Class Action Lawsuit Today!</div>
				<br>
				
				<div name="greeting">Dear Laura,</div>
				
				<div name="mail-body">
					<p>In 2014, the 3,500 successful class action lawsuits were awarded $2,300,000,000 for reparations to faulty products and medical treatment. If you’ve had any issues related to botched surgery, significant pain after treatment, or incorrect prescriptions, you could be entitled to significant reparations alongside hundreds of other patients.</p>
					
					<p>If you think you may have a case, take a look at our website, <a href="http://www.harbenlock.com/lawsuit-legal/">http://www.harbenlock.com/lawsuit-legal/</a>. One of our representatives would be glad to review your possible case with you over online messenger, by phone, or in person. You could join thousands of other clients working together to receive payment you deserve!</p>
					
					
					<div name="signature">
						Daniela Holsten<br>
						Director of Information Outreach<br>
						Center for Client Advocacy<br>
						352-555-4232
					</div>
