	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Pending Parking Violation </div>
				<br>
				
				<div name="greeting">Hi Alice, </div>
				
				<div name="mail-body">
					<p>It has been called to our attention that you have received a parking ticket that has not been paid. This ticket must be paid by the end of this month. Legal consequences will follow if the payment has not been made, which include an additional fine of $60. This could eventually lead to the revoking of your license.</p>
				
					<p>If you would like to review and/or contest your parking ticket and avoid fees, click on the link below to access your account and make a payment.</p>
					
					<a href="http://www.harbenlock.com/paymentdeadline-legal/">http://www.harbenlock.com/paymentdeadline-legal/</a><br><br>
					
					<div name="signature">
						David Thompson<br>
						Commune Patrol Manager<br>
						Gainesville FL.<br>
					</div>
