	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Gainesville Cooking Club</div>
				<br>
				
				<div name="greeting">Hello Ellen,</div>
				...
				<div name="mail-body">
					...
					<p>We would like to have a head count of everyone who will be attending, if you could please fill this quick questionnaire out</p>
				
					<a href="http://www.gainesvilleweekend.com/cookingclub-social/">http://www.gainesvilleweekend.com/cookingclub-social/</a>
