...
<head>
	...
	<title>UFL Online Survey - email 19 - interested</title>
	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Animal Rights Petition</div>
				<br>
				
				<div name="greeting">Hi Santiago,</div>
				
				<div name="mail-body">
				
					<p>My name is Anthony Moore. I live in your community and am trying to raise awareness for abused animals. There is a petition that I am asking all of our neighbors to sign. It is to stop the abuse of local rural animals here in Gainesville. Those animals deserve to live a life filled with happiness. Just put your own pets in their spot. To facilitate this petition I have made it online.</p>
				
					<p>If you are ready to put an end to rural animal abuse please click on the link below to sign my petition.</p>
					
					<a href="http://www.greaterreform.com/animalrights-ideological/">http://www.greaterreform.com/animalrights-ideological/</a><br>
					...
					Animal Activists of Gainesville
					</div>
