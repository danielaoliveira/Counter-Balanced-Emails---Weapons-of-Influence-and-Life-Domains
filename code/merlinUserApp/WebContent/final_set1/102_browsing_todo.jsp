...
<body>
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<p>Now, please use the internet for the next hour.  We would like you to spend your time as follows:</p>
			...
			<ul>
				...
				<h4>Once you are done with these activities, please click the next button.</h4>
