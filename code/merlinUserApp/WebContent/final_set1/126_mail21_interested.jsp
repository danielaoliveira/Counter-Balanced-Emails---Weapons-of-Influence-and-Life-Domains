	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				...
				<div name="greeting">Hello Uberto,</div>
				
				<div name="mail-body">
				
					<p>Your latest energy bill is now available to view online.</p>
					
					<p>Account Number: 245046885<br>Total Amount Due: $ 524.30</p>
					
					<p>Due to changes in our policy, we require that you view your utilities statements online via the link below.</p>
					
					<p>There are many options to pay your bill. Sign up for the Automatic Payment Plan to have your payment automatically deducted from your bank or credit card. Pay electronically online at the Account Center, visit an Authorized Payment Center or send a check by mail.</p>
				
					<p>To view your most recent bill, please follow the link below. You must log-in to your account or register for an online account to view your statement.</p>
				
					<a href="http://www.harperkellerservices.com/utilitystatements-financial/">http://www.harperkellerservices.com/utilitystatements-financial/</a><br><br>
