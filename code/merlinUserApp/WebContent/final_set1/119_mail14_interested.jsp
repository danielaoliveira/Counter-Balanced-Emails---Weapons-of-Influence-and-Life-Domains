	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Free Trial of Hypertension Medication</div>
				<br>
				
				<div name="greeting">Hello Nara</div>
				
				<div name="mail-body">
					<p>The American Pharmaceutical Outreach Program would like to offer you a free trial of Bystolic as part of our campaign to fight hypertension nation wide.</p>
					
					<p>Bystolic (nebivolol) is a pharmaceutical drug effective in treating hypertension and left ventricular failure.</p>
					
					<p>Qualified consumers with a history of hypertension are encouraged visit the link below to learn more:</p>

					<a href="http://www.spectrehealth.com/hypertension-health/">http://www.spectrehealth.com/hypertension-health/</a>			
