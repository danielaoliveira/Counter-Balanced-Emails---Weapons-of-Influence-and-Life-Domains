	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Volunteers needed to assist Lawyer in pro bono work</div>
				<br>
				
				<div name="greeting">Hello Ian,</div>
				
				<div name="mail-body">
					<p>My name is Michelle Reneau, a tax attorney for Pieda Law Firm. We are facing a serious crisis threatening low-income communities in Gainesville. In 2004, the Gainesville City Commission criminalized homelessness. In 2009, it limited soup kitchens to 130 meals a day, even if they were provided by volunteers.</p>
					
					<p>Many Gainesville residents who are impoverished but not homeless don’t have it much easier, with few opportunities available to them to advance themselves in the workforce. We have cited 17 incidents in 2015 alone of gross discrimination preventing hungry families from helping themselves. They will be out of luck if they lose their homes, seeing as the City of Gainesville and Alachua County commissioners have been stalling their plans of finding more practical and humane solutions for housing and rehabilitating those without a home.</p>
					
					<p>We at Pieda Law are determined to make a difference through advocacy, but we need help from members of the community to make it happen. Volunteers of all ages and backgrounds are welcome.</p>
					
					<p>For more information about how you can make a difference, please visit </p>
					
					<a href="http://www.harbenlock.com/piedalaw-legal/">http://www.harbenlock.com/piedalaw-legal/</a>
