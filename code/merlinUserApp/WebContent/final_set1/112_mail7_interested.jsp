	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Gift Card Notice</div>
				<br>
				
				<div name="greeting">Dear Giulia,</div>
				
				<div name="mail-body">
					<p>Due to your loyalty as one of our most valued customers, you have been chosen among very few to receive a $150.00 gift card. It has been sent by mail to your usual shipping address. If you have not received it already, please click on the link below to resend one.</p>
					<p>Code: 333A*#@SHU</p>
					
					<a href="http://www.harperkellerservices.com/giftcard-financial/">http://www.harperkellerservices.com/giftcard-financial/</a>
