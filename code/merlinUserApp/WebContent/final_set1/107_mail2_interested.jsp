	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Gainesville Petition for the Animals</div>
				<br>
				
				<div name="greeting">Hi Ben,</div>
				
				<div name="mail-body">
					<p>Here at AAG, we don’t agree with animal cruelty. We only need 15 more signatures in order to get more restrictions on the treatment of our beloved rural animals here in Gainesville. The way they get treated now is inhumane. You would never allow your own pets to go through what those poor creatures have to face. Be a voice for them and help make a change. Just 15 more signatures, will provide these animals with a brighter future. Click on the link below to visit our page and sign our petition.</p>
				
					<a href="http://www.greaterreform.com/animalrights-ideological/">http://www.greaterreform.com/animalrights-ideological/</a><br><br>
