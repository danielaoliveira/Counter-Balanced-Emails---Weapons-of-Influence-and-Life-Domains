	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Gainesville Wine Tasting Club</div>
				<br>
				
				<div name="greeting">Dear Tiffany,</div>
				
				<div name="mail-body">
					<p>My name is Ray, and I would like to invite you to a local wine-tasting club that a group of us are starting in the Gainesville area. If you like wine and are interested in developing a sensitive palette alongside friends and neighbors, join us for our first meeting early next month.</p>
					
					<p>We are still figuring out everyone's availability, so if you are interested, please click on the link below to fill out a quick questionnaire.</p>
					
					<p>http://www.gainesvilleweekend.com/winetestclub-social/</p>
					...
					<div name="signature">
						Ray Whitacre<br>
						President,<br>
						Gainesville Wine Tasting Club<br>
					</div>
