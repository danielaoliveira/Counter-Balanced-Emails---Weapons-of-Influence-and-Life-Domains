	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Antivirus Renewal</div>
				<br>
				
				<div name="greeting">Hello Yesenia,</div>
				
				<div name="mail-body">
					<p>Your software antivirus protection system will expire within one week. You have received multiple warnings earlier this month. In order to renew the protection system, you must follow the instructions on the reminder pop ups periodically activated by your computer. If you have not received any pop ups, click the link below to visit the renewal portal where the transaction may be done.</p>
					
					<p>http://www.bolzensecurity.com/antivirus-security/ </p>
					
					<div name="signature">
					Wilson Brown<br>
					Customer Security Associate<br>
					SOFTWARE TECH©<br>
					</div>
