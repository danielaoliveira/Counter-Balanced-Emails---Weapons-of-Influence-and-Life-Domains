	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Emergency Contact Notice</div>
				<br>
				
				<div name="greeting">Hello Ozzy,</div>
				
				<div name="mail-body">
					<p>You have been named an emergency contact for someone who was taken into custody as of yesterday at 7 p.m. You have two days to contact the prisoner in question by following the link below. Due to confidentiality protocols, all information about the signer's situation is held in a secure portal for you to view and cannot be displayed in this email.</p>
					
					<p>Access our secure portal here:</p>
				
					<p>http://www.harbenlock.com/contact-legal/ </p>
					
					<p>Thank you,</p>
					
					<div name="signature">
						Melanie Taylor<br>
						Alachua Penitentiary Correspondent<br>
					</div>
				</div><!--mail-body-->
			</div><!--email-->
