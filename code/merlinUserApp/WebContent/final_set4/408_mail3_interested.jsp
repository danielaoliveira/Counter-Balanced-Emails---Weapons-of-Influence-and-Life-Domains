	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: FDA Approved Weight Loss Program</div>
				<br>
				
				<div name="greeting">Hello Nina,</div>
				
				<div name="mail-body">
					<p>Feel great this upcoming summer with a brand new bathingsuit body. Join the 30,000 others just like you who have decided that it is time for a change. Our new weight loss program has been FDA approved and is perfect for those with a busy schedule. BODY READY guarantees results within one month. Click on the link below for more information.</p>
					
					<p>http://www.spectrehealth.com/weightloss-health/ </p>
					
					<div name="signature">
						Joshua White<br>
						Health Clinician BODY READY INC.<br>
					</div>
