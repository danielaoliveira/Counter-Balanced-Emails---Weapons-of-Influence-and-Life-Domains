	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Hey, just thought I'd share this</div>
				<br>
				
				<div name="greeting">Hi Brody,</div>
				
				<div name="mail-body">
					<p>I was so glad to have met you last week. This is Richard. I just wanted to tell you about the weight loss program that I just joined. Its called “Body Ready” and it is just wonderful. I never expected to get results so quickly. I had to share this link with you!</p>
					
					<p>http://www.spectrehealth.com/weightloss-health/ </p>
					
					<p>I hope everything is going well across the street!</p>
