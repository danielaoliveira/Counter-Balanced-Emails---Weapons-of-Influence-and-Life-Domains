	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Alachua Residential Survey on Funding for Muslim Cultural Center</div>
				<br>
				
				<div name="greeting">Hello Ellie,</div>
				
				<div name="mail-body">
				
					<p>The Alachua County Board of Project Budgeting is hosting a survey for residents regarding the proposition to fund a Muslim Cultural Center near Bo Diddley Plaza in Gainesville, Fla. While this center is not meant to be an explicit endorsement of any particular religious views, concerns about its propriety are sufficient to warrant an in-depth examination of the sentiments of Alachua County residents.</p>
				
					<p>You have been selected as part of a generalizable random sample of the Alachua County residential community. Failure to participate in this survey will result in inaccurate data about public opinion.
Please follow the link below to fill out this brief, 5-minute survey.</p>

					<p>http://www.greaterreform.com/muslimfund-ideological/</p>
					
					<p>Thank you</p>
					
					<div name="signature">
					Steven Geller<br>
					Executive Research Assistant<br>
					Alachua County Board of Project Budgeting<br>
					</div>
