	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Try American Nation Subscription Today!</div>
				<br>
				
				<div name="greeting">Dear Qasim,</div>
				
				<div name="mail-body">
					<p>Last month 1,000 people claimed their free three month subscription to American Nation™, and upstart political magazine. This opportunity has been extended to you by a friend who already has claimed their offer.</p>
					
					<p>In a divisive political landscape, more and more people look for the unbiased, bipartisan reporting offered by AN. We've received praise from countless readers for our articles on breaking gridlock in Congress, ensuring peace in the Middle East, or securing the wellbeing of American citizens across the globe.</p>
					
					<p>Best of all, if you don’t like our services after your free three months, you can cancel at any time. We won’t even take your billing information until you’re ready to sign up. Collect today at http://www.bolzensecurity.com/ansubscription-security/ !</p>
					
					
					<div name="signature">
						Peter Fulton<br>
						Director of Media and Outreach<br>
						American Nation Today<br>
					</div>
				</div>
			</div><!--email-->
