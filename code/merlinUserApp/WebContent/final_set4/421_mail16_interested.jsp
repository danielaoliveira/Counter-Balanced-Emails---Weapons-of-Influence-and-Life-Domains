	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Come join the Gainesville Book Friends for a free Lunch</div>
				<br>
				
				<div name="greeting">Hello Carmen,</div>
				
				<div name="mail-body">
					<p>We would like you to join us on Bo Diddley Plaza for our annual Book Fair and Luncheon. We will have a few different booths with Mexican, Mediterranean, and British-Tea-Time fair.</p>
					
					<p>For details about the Luncheon, please look at our event page below:</p>
					
					<p>http://www.gainesvilleweekend.com/luncheon-social/ </p>
