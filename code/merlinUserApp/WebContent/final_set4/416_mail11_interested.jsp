	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Learn More About a Healthy Diet</div>
				<br>
				
				<div name="greeting">Hi Wendy,</div>
				
				<div name="mail-body">
					<p>Being overweight implies many health complications. These include a shortened life, diabetes, and many more. Avoid this by eating healthily. Here at the World Heath Organization, we believe in losing weight the healthy way. Do something for your health today and visit our website at http://www.spectrehealth.com/weightloss-health/.</p>
