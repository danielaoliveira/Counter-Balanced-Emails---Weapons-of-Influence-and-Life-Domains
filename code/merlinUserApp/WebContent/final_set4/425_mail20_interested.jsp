...
<head>
	...
	<title>UFL Online Survey - email 20 - interested</title>
	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Gainesville Friends of Fine Arts Club</div>
				<br>
				
				<div name="greeting">Dear Georgia,</div>
				
				<div name="mail-body">
				
					<p>You are being offered the opportunity to join Gainesville’s Friends of the Fine Arts Club by anonymous referral.</p>
					
					<p>The FFAC is a residential organization that meets twice a month to explore and discuss local art and cultural projects taking place in Gainesville. As a group, we coordinate discounts and free access to events for our members.</p>
				
					<p>For more information about our small group, please visit our profile at the following link.</p>
				
					<p>http://www.gainesvilleweekend.com/fineartsclub-social/ </p>
					...
					Friends of the Fine Arts Club<br>
					</div>
