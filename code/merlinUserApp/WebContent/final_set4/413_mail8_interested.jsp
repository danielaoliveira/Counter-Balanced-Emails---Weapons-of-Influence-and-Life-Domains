	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Animal Activists of Gainesville</div>
				<br>
				
				<div name="greeting">Hello Saul,</div>
				
				<div name="mail-body">
					<p>My name is Kristina Erb, and I am inviting you to join the Animal Activists of Gainesville for for its first annual Plant-Based Food Festival on June 2. We are offering member of the Alachua County community to learn about the benefits of a plant-based diet, complete with cooking demonstrations from celebrity chefs.</p>
					
					<p>The Animal Activists of Gainesville shares a vision of a world where every animal lives safe, happy, and free from human exploitation and violence. We hope that you will join us in the movement to liberate the fellow inhabitants of our planet.</p>
					
					<p>Learn more about the Plant-Based Food Festival and the Animal Activists of Gainesville at http://www.greaterreform.com/animalprotect-ideological/.</p>
					...
					Kristina Erb<br>
					Secretary<br>
					Animal Activists of Gainesville<br>
					</div>
