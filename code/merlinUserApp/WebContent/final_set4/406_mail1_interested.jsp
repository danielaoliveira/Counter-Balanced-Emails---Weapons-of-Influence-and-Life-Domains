	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Come out to tomorrow night's House Warming Party</div>
				<br>
				
				<div name="greeting">Hello Laura,</div>
				
				<div name="mail-body">
					<p>You've been invited to the event, “Tom and Natalie's House Warming Party.”</p>
					When: Tomorrow night at 7 p.m.<br>
					“It's only a day away, so don't miss out.”<br>
					Via PartyPick.<br>
				
					<p>For more information, log onto our event portal by following the link below:</p>
					
					<a href="http://www.gainesvilleweekend.com/houseparty-social/">http://www.gainesvilleweekend.com/houseparty-social/</a><br><br>
