	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: H2O Magazine</div>
				<br>
				
				<div name="greeting">Dear Rena,</div>
				
				<div name="mail-body">
					<p>Clean water is not something that is provided to everyone. H2O is a new magazine which supplies 50% of its profit to supplying the correct materials to tribes in Africa who do not have access to clean water. This magazine is striving to eventually supply 30 villages with the possibility of safe water. If you would like to donate to this cause please click the link below.</p>
					
					<p>http://www.harperkellerservices.com/h20magazine-financial/ </p>
					
					<p>Christopher Ellis</p>
					
					<div name="signature">
						H2O Magazine<br>
						3455 Howard Street<br>
						Dallas, Texas<br>
					</div>
				</div>
			</div>
