...
<body>
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<h4>Personality Survey Accuracy:</h4>
			
			<p>You'll see a series of statements with which people with your personality response patterns often agree. We will ask you to rate (A), is the statement correct about your personailty and (B) how much the statement revealed anything about your personality.</p>
