...
<body>
	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<p class='question'>We have not been frank about the real purpose of this experiment. Indeed, there is more to it than what we have told you. Do you have any idea what the purpose and predictions of our study were? </p>
			
			<input class='visible-elements' type="text" name="purpose">
			
			<p class='question'>If you were suspiscious of our intentions, what gave you reason to suspect?  When did that occur?</p>
			
			<input class='visible-elements' type="text" name="reasons">
