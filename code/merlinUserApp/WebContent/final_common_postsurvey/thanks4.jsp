...
<body>
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<p>In this study we were actually examining how the effectiveness and types of Internet attacks varied across age group. During the past three weeks we presented you with simulations of Internet attacks. </p>
			
			<p>This study is concerned with factors that affect the type and the effectiveness of Internet attacks. For example, people tend to say yes to requests made from someone with a perceived authority. We tracked your web activities and sent you some fictitious malicious e-mails in the course of these three weeks to understand the base rate of web activities for young and older adults, respectively, and to get an idea of the types of Internet attacks young and older adults are particularly vulnerable to.</p>
