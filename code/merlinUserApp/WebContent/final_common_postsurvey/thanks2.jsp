...
<body>
	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<p>We can’t always reveal the true purpose of a study because it might affect our results. If we tell people the real purpose or prediction of the experiment, they may deliberately do whatever it is they think we want them to do, just to help us out. It is also possible that if we tell people our predictions, they might deliberately act in the opposite way. In either situation, we would not have a good indication of how people normally act. </p>
			
			<p class='question'>Do you understand why it might sometimes be necessary to conceal the real purpose and predictions of an experiment?</p>
