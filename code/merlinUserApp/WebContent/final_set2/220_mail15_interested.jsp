	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Come out to the Gainesville Art Bash!</div>
				<br>
				
				<div name="greeting">Hi Jenny,</div>
				
				<div name="mail-body">
					<p>My name is Daniela, and if you’re receiving this, then it’s because you expressed interest in art exhibitions from my studio! If you come out this next Saturday, you will get an exclusive look at some of the latest projects going on in Gainesville. The Art Bash is an event in which we unveil commissioned and personal works either finished or in progress in our community. It is attended every year by folks who want to keep abreast of the goings on in the Alachua County world of art.</p>
					
					<p>If you miss out on this event, then many of these works won’t be available to you for perhaps another year. And some of the most impressive of the bunch tend to be bought up by collectors right away. This Saturday may be your only chance to catch the most promising paintings and drawings produced this season before they are bid on and taken away.</p>
					
					<p>Here’s the link to our Gainesville Art Bash event: http://www.gainesvilleweekend.com/fineartsclub-social/</p>

					<p>Thanks so much for being a part of the Gainesville art scene!</p>			
