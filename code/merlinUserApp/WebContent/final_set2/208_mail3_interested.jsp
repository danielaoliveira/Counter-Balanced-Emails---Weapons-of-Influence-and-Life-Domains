	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Vote on the next celebrity to bring to our annual event</div>
				<br>
				
				<div name="greeting">Hi Xena,</div>
				
				<div name="mail-body">
					<p>Gainesville’s Pop Culture and the Arts Seminar is gearing up for Fall 2015’s event. Last year we brought Chinese American cellist Ming Ma and actor South African comedian Trevor Noah.</p>
					
					<p>If you would like to vote on this year’s line up, click the link below, vote on celebrities in the categories that interest you, and you may win the chance to meet them in person!</p>
					
					<p>Check out what’s cooking for Pop Culture and the Arts 2015 at http://www.gainesvilleweekend.com/fineartsclub-social/</p>
