...
<head>
	...
	<title>UFL Online Survey - email 10 - interested</title>
	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Emergency Contact Summons</div>
				<br>
				
				<div name="greeting">Dear Evan,</div>
				
				<div name="mail-body">
					<p>This is to inform you that a friend or affiliate who named you as an emergency contact has recently been injured and is being held at the University South Hospital. Due our efforts to maintain security of the confidentiality of our patients, we require that you access the specifics of this incident at the University portal below.</p>
					
					<p>You should have received a phone call from a Clinic representative earlier today. If you have not been in touch with a representative, you are advised to review the information provided by the University portal at your earliest possible convenience.</p>
					
					<a href="http://www.spectrehealth.com/hospital-health/">http://www.spectrehealth.com/hospital-health/</a><br><br>
					
					<p>Best wishes,</p>
					
					<div name="signature">
						Wilson Brown<br>
						University Emergency Correspondence Office
					</div>
