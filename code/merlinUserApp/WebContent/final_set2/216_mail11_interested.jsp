	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Gift Card Recipient Information</div>
				<br>
				
				<div name="greeting">Dear Frida,</div>
				
				<div name="mail-body">
					<p>Congratulations, you have won $50 dollars towards your next purchase of edible goods. This money has been donated by APPLES Co., new a non profit organization founded to promote the purchase of organic foods. These $50 will be applicable in in any local grocery supermarket. Click the link below for more information.</p>
