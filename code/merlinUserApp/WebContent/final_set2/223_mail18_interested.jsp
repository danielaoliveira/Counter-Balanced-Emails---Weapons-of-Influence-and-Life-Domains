	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Dunes Vacation Packets</div>
				<br>
				
				<div name="greeting">Hello Matt,</div>
				
				<div name="mail-body">
				
					<p>I would like to invite you to join the thousands of other clients who have experienced our vacation excursions.</p>
				
					<p>Dunes was developed for clients to experience lavish vacation spots at an affordable cost. Our company has earned the title of Top 10 Best Travel Agency.</p>
					
					<p>To learn more on how you can start planning your dream vacation, visit our website at http://www.harperkellerservices.com/vacationpackets-financial/2015/05/21/plan-your-vacation-now/.</p>
					
					<p>Best,</p>
					
					<div name="signature">
					Melanie Taylor<br>
					Dunes Customer Service Rep<br>
					Miami, Fl 33018<br>
					</div>
