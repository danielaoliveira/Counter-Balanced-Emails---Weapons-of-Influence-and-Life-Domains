	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Homeless Petition, Alachua</div>
				<br>
				
				<div name="greeting">Dear Nicole,</div>
				
				<div name="mail-body">
				
					<p>How are you feeling today?</p>
				
					<p>I would like to elicit your cooperation in signing a petition asking city council to implement a comprehensive strategy for mobilizing the homeless away from major centers in downtown Gainesville by providing viable alternatives.</p>
				
					<p>To view this petition and sign, please click the link below.</p>
					...
					Olivia Jackson<br>
					Secretary,<br>
					Alachua Residential Safety Committee
					</div>
