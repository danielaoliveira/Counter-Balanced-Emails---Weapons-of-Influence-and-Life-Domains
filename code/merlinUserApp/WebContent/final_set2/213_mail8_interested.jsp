	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Changes in Your Prescription</div>
				<br>
				
				<div name="greeting">Hello Christopher,</div>
				
				<div name="mail-body">
					<p>Your general health care provider has reported changes to your current medication. This is crucial as these alterations should be taken care of immediately. No personal information regarding this change may be viewed via email due to HIPPA confidentiality. Click on the portal link below to access your information from your providers’ personal patient data base as soon as possible.</p>
