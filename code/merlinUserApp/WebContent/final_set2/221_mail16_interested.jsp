	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Petition to improve health among young students</div>
				<br>
				
				<div name="greeting">Hello Ken,</div>
				
				<div name="mail-body">
					<p>Recent legislations have left little funding for health and wellness programs in Alachua County elementary and middle schools. The programs that were cut were meant to teach children about good nutrition and allow them a variety of opportunities to join athletic sports and recreational activities to stimulate healthful growth and stave off the epidemics of obesity and diabetes.</p>
					
					<p>To sign our petition to bring back these programs and find out more about who we are, visit our page by following the link below.</p>
					
					<p>http://www.spectrehealth.com/youngstudents-health/ </p>
					
					<p>Thank you,</p>
					
					<div name="signature">
					Peter Fulton<br>
					Parents for a Healthier Alachua (PHA)<br>
					</div>
