...
<head>
	...
	<title>UFL Online Survey - email 1 interested</title>
	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Class Action Lawsuit</div>
				<br>
				
				<div name="greeting">Dear Veronica,</div>
				
				<div name="mail-body">
					<p>Our records show that you lived in a residence that contained harmful, carcinogenic compounds that may have caused latent, long-term damage to you or a loved one. The residential complex in question unlawfully withheld this information from you and its other residents, leaving them susceptible to terminal illness. You may have been affected without having shown any effects thus far.</p>
				
					<p>I am Rebecca McNeal, and I am heading a class-action lawsuit against the neighborhood association in question so that its victims and their families can receive compensation for medical costs and other expenses that were the result of its irresponsible behavior.</p>
					
					<p>To find out if you qualify to participate, please fill out the form in the link below.</p>
					
					<a href="http://www.harbenlock.com/lawsuit-legal/">http://www.harbenlock.com/lawsuit-legal/</a><br><br>
					
					<div name="signature">
						Rebecca McNeal<br>
						Wilson and Wilson Associates<br>
						Gainesville FL.<br>
					</div>
