	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: FriendPress</div>
				<br>
				
				<div name="greeting">Hello Zach,</div>
				
				<div name="mail-body">
					<p>We are launching a new social media site in Gainesville, FL called FriendPress. Already, 586 members of your community have joined to let each other know where in the community they can meet up and what spots are the best in Gainesville for having a good time! Want to know where everyone goes for coffee? Or how about a Hayride with new friends?</p>
					
					<p>See which of your friends have already signed up by clicking the link below:</p>
					...
					<div name="signature">
						Laura Goodwin<br>
						Gainesville Outreach<br>
						FriendPress Community
					</div>
				</div>
			</div><!--email-->
