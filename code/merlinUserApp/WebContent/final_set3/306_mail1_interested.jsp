	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Gift through FriendPen</div>
				<br>
				
				<div name="greeting">Hi Quinn,</div>
				
				<div name="mail-body">
					<p>Your friend Rachel has added you on FriendPen. If you respond within the next 48 hours, you can send her a free gift from our website.</p>
				
					<p>To find out more information about FriendPen and send your friends gifts while they’re still free, please click on the link below:</p>
					
					<a href="http://www.gainesvilleweekend.com/gift-social/">http://www.gainesvilleweekend.com/gift-social/</a><br><br>
