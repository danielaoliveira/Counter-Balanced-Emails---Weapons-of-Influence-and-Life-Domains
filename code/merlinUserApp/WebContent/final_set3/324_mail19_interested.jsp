	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Language Learning Discount</div>
				<br>
				
				<div name="greeting">Hi Ivan,</div>
				
				<div name="mail-body">
				
					<p>Within the next five years, people who only know one language will be only half as likely to find employment as those who are at least bilingual.</p>
				
					<p>If you would like to beat the trend and add another language to your skill set, then you are in luck.</p>
				
					<p>You have been selected to receive $1000 off a language course! Go to http://www.harperkellerservices.com/languagelearning-financial/ to enter your code to receive your offer!</p>
					
					<a href="http://www.greaterreform.com/helphomeless-ideological/">http://www.greaterreform.com/helphomeless-ideological/</a><br>
					
					
					<p>Code: Af35dR2ff-6425s<p>
					LOYOLA LANGUANGE INC.<br>
					1-800-LOYOLALEARN<br>
