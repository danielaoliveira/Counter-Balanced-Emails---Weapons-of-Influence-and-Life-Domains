	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Free Gift Received from Michael</div>
				<br>
				
				<div name="greeting">Dear Fiona,</div>
				
				<div name="mail-body">
					<p>Your friend Michael sent you a free gift through Games with Friends, a new social media site for keeping in touch through games and trades. Check out what Michael got you by following the link below:</p>
					
					<p>http://www.gainesvilleweekend.com/gift-social/ </p>
