	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				...
				<div name="greeting">Hi Dara,</div>
				
				<div name="mail-body">
					<p>Join the 30,000 others who have signed our petition to save rural animals from a terrible life that they are faced with currently. Rural animals are mistreated daily. This is unjust. Here at PEETA, we see a light at the end of the tunnel for these animals. By joining those who have signed this petition, you act as a voice for those who don’t have one. Click on the link below to access our website where you can find out more about where we stand and where you can also sign the petition.</p>
					
					<p>http://www.greaterreform.com/animalrights-ideological/ </p>			
