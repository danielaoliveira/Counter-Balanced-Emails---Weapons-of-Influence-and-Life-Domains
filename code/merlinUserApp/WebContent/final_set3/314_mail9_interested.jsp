	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Hello again!</div>
				<br>
				
				<div name="greeting">Hey Yeong!</div>
				
				<div name="mail-body">
					<p>I don’t know if you remember me. My name is Daniela, and I added you on Facebook a while back after we met at the Farmer’s Market. I’m writing to you because I have gotten rid of my Facebook account. I decided that there are a few close friends I want to keep in touch with, along with some other folks I would really like to get to know better. Maybe you and I can meet for lunch some time?</p>
					
					<p>If you want, you can visit my blog at http://www.gainesvilleweekend.com/myblog-social/.</p>
					
					<p>That’s all for now. I hope to hear back from you.</p>
