	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Relay for Children Coming Up!</div>
				<br>
				
				<div name="greeting">Hello Wanda,</div>
				
				<div name="mail-body">
					<p>The goal of Relay for Children with Chronic Illness is to raise $100,000 by August 13, 2015. We are so close to reaching our goal!</p>
					
					<p>Each donation helps make it possible to find a cure for cancer. Relay for Health is around the corner!</p>
					
					<p>Visit http://www.harperkellerservices.com/relayforchildren-financial/ to help us reach our goal!</p>
					...
					<div name="signature">
						...
						Relay for Children with Chronic Illness<br>
					</div>
				</div>
			</div>
