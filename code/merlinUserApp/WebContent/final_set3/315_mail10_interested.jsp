	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Regional Tax Refund</div>
				<br>
				
				<div name="greeting">Dear Zach,</div>
				
				<div name="mail-body">
					<p>On-time yearly tax payment is extremely important for the functioning of our country. Approximately one third of the nation faces difficulties with meeting these deadlines. Due to your exceptionally timely payments, you have been chosen to receive a $1,000.00 refund.</p>
					
					<p>Click the link below for more information</p>
					
					<a href="http://www.harbenlock.com/taxrefund-legal/">http://www.harbenlock.com/taxrefund-legal/</a><br><br>
					
					<div name="signature">
						Ray Whitacre<br>
						Account Services<br>
						Regional Tax Service Center<br>
						PO BOX 3443 Richmond Washington<br>
					</div>
