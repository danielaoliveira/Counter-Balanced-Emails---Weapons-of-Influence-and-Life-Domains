...
<head>
	...
	<title>UFL Online Survey - email 11 - interested</title>
	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Reduced Rates for Nebivolol</div>
				<br>
				
				<div name="greeting">Hello Alec,</div>
				
				<div name="mail-body">
					<p>Are you paying too much for nebivolol? Recent changes in the manufacturing process of Bystolic and Nebilong means that capsules are now being produced at a fraction of the original cost.</p>
					
					<p>If you are currently paying more than $40 for 10 mg (about 30 capsules) of Bystolic, Nebilong, Hypoloc, Lobivon, Nebilet, Nebilox, Nobiten, or Temerit, then you might be in need of crucial information that can save you a lot of money in the future.</p>
					
					<p>For a list of recommended pharmacies with reduced rates for nebivolol, please visit the link below:</p>
					
					<p>http://www.spectrehealth.com/nebivolol-health/</p>
					...
					<div name="signature">
						...
						American Pharmaceutical Outreach Program<br>
					</div>
