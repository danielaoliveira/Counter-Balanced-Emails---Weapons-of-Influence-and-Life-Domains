	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Find out which politicians have your best interest at heart</div>
				<br>
				
				<div name="greeting">Hello Hannah,</div>
				
				<div name="mail-body">
				
					<p>We’re launching a new website that will break down actions of government based on the findings of the U.S.’s top political analysts. Our researchers can match voters with the politicians they really should be voting for based on an in-depth review of politicians’ full political history. They will compare the track records of every elected official to the personal values of voters who join our site. Have our government experts give you the full story behind which senators and president you should vote for and why.</p>
				
					<p>http://www.greaterreform.com/voter-ideological/ </p>
					
					<div name="signature">
					Laura Goodwin<br>
					South East Bureau for Voter Information<br>
					</div>
