	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Free Internet Security App</div>
				<br>
				
				<div name="greeting">Dear Rin,</div>
				
				<div name="mail-body">
					<p>Three out of five Americans have their credit card information stolen over the Internet. Avoid this problem before it occurs. You can receive our Internet Security Application, which will protect you from hackers and theft.</p>
				
					<p>Keep your accounts safe, visit http://www.bolzensecurity.com/internetsafe-security/.</p>
					
					<div name="signature">
						Anthony Moore<br>
						CREDIT SAFE CO.<br>
						P.O. BOX 3499 Richmond, Washington<br>
					</div>
