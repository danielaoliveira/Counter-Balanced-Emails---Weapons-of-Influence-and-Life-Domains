	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: PetLove Donations</div>
				<br>
				
				<div name="greeting">Dear Uma,</div>
				
				<div name="mail-body">
					<p>Would you like to put an end to animal abuse? 3 out of 10 domestic animals in the US are currently being abused by their owners. That is why we started our non-profit organization, PetLove, to lobby for additional support for shelters that take in abused pets. Help us end this unfair treatment of our beloved pets. Last year we were able to collect just over 15,000 signatures, and this year we look forward to collecting more. Make your mark by signing the petition to help these animals have the future they deserve.</p>
					
					<p>Please click the link below to sign digitally!</p>
				
					<p>http://www.greaterreform.com/petdonate-ideological/ </p>
