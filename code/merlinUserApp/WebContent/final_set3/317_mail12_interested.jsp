	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Fairpoint Retirement</div>
				<br>
				
				<div name="greeting">Hi Brenda,</div>
				
				<div name="mail-body">
					<p>Join Fairpoint retirement home town. This high-end long-term stay offers housing, community activities, and a peaceful environment built for relaxation. Stay is all inclusive, and personal accommodation plans are available. Space is very limited, so act now. Please click on the link below for more information.</p>
					
					<p>http://www.harperkellerservices.com/retirement-financial/ </p>
					
					
					<div name="signature">
						Nicole Summer<br>
						Fairpoint Retirement Community<br>
						55a W23rd CT. Ocala<br>
					</div>
