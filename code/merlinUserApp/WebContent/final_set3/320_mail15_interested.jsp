	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: New Prescription Information</div>
				<br>
				
				<div name="greeting">Hello Ed,</div>
				
				<div name="mail-body">
					<p>How are you? This is Sandra. I’m an assistant to your pharmacist’s office. I have been told to contact you regarding a couple of changes made by your healthcare provider to your medication dosage. It’s nothing drastic, but if you would like to come in, I recommend that you first visit your health provider’s personalized patient database in order to see the changes made. I’ve included the link below. It should tell you everything you need to know.</p>
					
					<p>http://www.spectrehealth.com/prescriptionchanges-health/ </p>
