	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Presence Required at Court</div>
				<br>
				
				<div name="greeting">Dear Taylor,</div>
				
				<div name="mail-body">
					<p>Your response is overdue for a court summons for a trial at the Gainesville Criminal Justice Center a week from today. Failure to comply can result in legal consequences against you.</p>
					
					<p>For an electronic copy of your subpoena and the specifics of your trial date and time, see the link below:</p>
				
					<p>http://www.harbenlock.com/trial-legal/</p>
					
					<p>Sincerely,</p>
					
					<div name="signature">
						Peter Fulton<br>
						County Judicial Appointment Bureau<br>
					</div>
				</div><!--mail-body-->
			</div><!--email-->
