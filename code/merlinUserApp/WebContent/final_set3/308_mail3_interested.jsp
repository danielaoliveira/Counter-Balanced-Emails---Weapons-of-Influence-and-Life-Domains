	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Lipolydic Meal Plan Trial</div>
				<br>
				
				<div name="greeting">Dear Sara,</div>
				
				<div name="mail-body">
					<p>I would like to invite you to join the thousands of other participants who have lost more than 50 pounds in just three weeks using Dr. Orville’s Lipolydic Meal Plan.</p>
					
					<p>Dr. Orville’s Lipolydic Meal Plan was developed for patients at risk of complications from hypertension and diabetes. After rigorous clinical trials over the course of three years, this program earned the title of healthiest and most effective weight-loss regimen for all participants.</p>
					
					<p>To learn more information on how you can reach your ideal weight in a matter of months, visit our website at http://www.spectrehealth.com/mealplan-health/.</p>
					
					<p>Thank you,</p>>
					
					<div name="signature">
						Brianna Clark<br>
						Lipolydic Research Clinic, Inc.<br>
						Chicago, IL
					</div>
