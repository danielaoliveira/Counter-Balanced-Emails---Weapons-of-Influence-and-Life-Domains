	...
	<div id='content'>
		...
		<form id="hidden_form" method="POST" action="http://merlin.ece.ufl.edu:8088/merlinUserApp/survey">
			...
			<div name="email" id='email'>
				<div name="subject" class='question'>Subject: Message from Collin Sam</div>
				<br>
				
				<div name="greeting">Hello Janet,</div>
				
				<div name="mail-body">
				
					<p>We are writing to inform you that your friend Collin has left a message for you at this address since he is out of the country and has no other way of communicating with you. In order to view the message and respond back it is required that you get a membership for Messages2friends.</p>
				
					<p>To sign up, please go to http://www.gainesvilleweekend.com/message2friends-social/.</p>
					
					<p>Thank you and Enjoy</p>
					
					<div name="signature">
					Jennifer Carson<br>
					Enrollment and Outreach<br>
					</div>
